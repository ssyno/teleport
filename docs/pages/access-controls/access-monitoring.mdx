...
auth_service:
  access_monitoring:
    ...
    report_results: s3://audit-log-example/report_results
```
...
**Suggestion:**  Use short-lived tokens to reduce risk of compromise or [delagated](../reference/join-methods.mdx) joining when possible.
